...
Private Const OH_MSG_HOOK = WM_USER + 1
...
Ret = WriteProcessMemory(SelectedProcessHandle, RemoteDllPath, ByVal StrDll, Len(DLLPath) + 1, Ret)
...
IsRunning = True
Debug.Print "The hwnd is " & TheHookHWND
Do While IsRunning = True
    If PeekMessage(aMsg, TheHookHWND, 0, 0, 1) <> 0 Then
        If aMsg.message = WM_QUIT Or aMsg.message = WM_DESTROY Then GoTo Done
...
TheHookHWND = CreateWindowEx(0&, "NTFSClass", "The Hidden Hook", &H400, 300, 300, 448, 298, 0, 0, App.hInstance, ByVal 0&)
